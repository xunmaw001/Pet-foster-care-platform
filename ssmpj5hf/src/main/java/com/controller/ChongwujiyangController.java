...
public class ChongwujiyangController {
    ...
    public R page(@RequestParam Map<String, Object> params,ChongwujiyangEntity chongwujiyang, 
		...
		if(tableName.equals("chongzhu")) {
			chongwujiyang.setChongzhuzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("chongzhu")) {
			wrapper.eq("chongzhuzhanghao", (String)request.getSession().getAttribute("username"));
		}
