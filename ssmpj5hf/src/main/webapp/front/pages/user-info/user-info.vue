...
<view class="content">
	<view class="box" :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"24rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
		<view :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"rgba(179, 179, 179, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 0 6rpx","width":"100%","borderStyle":"solid","height":"auto"}' v-if="tableName=='chongzhu'" class="cu-form-group">
			<view class="title" :style='{"padding":"0","boxShadow":"0 0 16rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"160rpx","lineHeight":"88rpx","fontSize":"28rpx","borderStyle":"solid"}'>宠主账号</view>
			<input disabled="true"  style="padding: 0 30upx" :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(54, 111, 112, 1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"16rpx","borderWidth":"2rpx","width":"100%","lineHeight":"88rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.chongzhuzhanghao" placeholder="宠主账号"></input>
		</view>
		<view :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"rgba(179, 179, 179, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 0 6rpx","width":"100%","borderStyle":"solid","height":"auto"}' v-if="tableName=='chongzhu'" class="cu-form-group">
			<view class="title" :style='{"padding":"0","boxShadow":"0 0 16rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"160rpx","lineHeight":"88rpx","fontSize":"28rpx","borderStyle":"solid"}'>宠主姓名</view>
			<input   style="padding: 0 30upx" :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(54, 111, 112, 1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"16rpx","borderWidth":"2rpx","width":"100%","lineHeight":"88rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.chongzhuxingming" placeholder="宠主姓名"></input>
		</view>
		<view :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"rgba(179, 179, 179, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 0 6rpx","width":"100%","borderStyle":"solid","height":"auto"}' v-if="tableName=='chongzhu'" class="cu-form-group">
			...
			<view v-if="tableName=='chongzhu'" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"rgba(179, 179, 179, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 0 6rpx","width":"100%","borderStyle":"solid","height":"auto"}' class="cu-form-group select">
                                ...
                                <picker  @change="chongzhuxingbieChange" :value="chongzhuxingbieIndex" :range="chongzhuxingbieOptions">
		...
		<view :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"rgba(179, 179, 179, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 0 6rpx","width":"100%","borderStyle":"solid","height":"auto"}' v-if="tableName=='chongzhu'" @tap="chongzhutouxiangTap" class="cu-form-group">
...
<script>
	export default {
		...
		async onLoad() {
			...
			// 自定义下拉框值
			if(this.tableName=='chongzhu'){
				this.chongzhuxingbieOptions = "男,女".split(',');
				this.chongzhuxingbieOptions.forEach((item, index) => {
					if(item==this.ruleForm.xingbie) {
						this.chongzhuxingbieIndex = index;
					}
				});
			}
			this.styleChange()
		...
		methods: {
                        // 下拉变化
                        chongzhuxingbieChange(e) {
                                this.chongzhuxingbieIndex = e.target.value
                                this.ruleForm.xingbie = this.chongzhuxingbieOptions[this.chongzhuxingbieIndex]
                        },
			styleChange() {
				this.$nextTick(()=>{
